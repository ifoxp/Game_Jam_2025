...
namespace _Scripts.Utilities
{
    public static class RandomAdditional
    {
        ...
        {
            var center = boxCollider.center + boxCollider.transform.position;
            ...
            var randomPoint = center + new Vector3(randomX, randomY, randomZ);
            return boxCollider.transform.TransformPoint(randomPoint - boxCollider.center);
        }
    }
}